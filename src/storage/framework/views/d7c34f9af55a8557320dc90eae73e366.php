<section>
    <header>
        <h2 class="text-lg font-medium">
            <?php echo e(__('Atualizar perfil')); ?>

        </h2>

        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            <?php echo e(__("Atualize as informações do seu usuário.")); ?>
...
<?php /**PATH /var/www/app/resources/views/profile/partials/update-profile-information-form.blade.php ENDPATH**/ ?>